...
\end{figure}
\newline
Die Fits werden mit linearer Regression der Form $f(x) = a * x + b $ mit Python
berechnet.
Für die Parameter ergeben sich folgende Werte:
\begin{align*}
  a_\symup{schwarz}   &= \,(1.047\pm0.007)*10^{-10} \si{\frac{\volt}{\kelvin^4}} \\
  b_\symup{schwarz}   &= (-0.836\pm0.010) \si{\volt} \\
  a_\symup{glaenzend} &= \,(7.3\pm0.5)*10^{-12} \si{\frac{\volt}{\kelvin^4}} \\
  b_\symup{glaenzend} &= (-0.062\pm0.006) \si{\volt} \\
  a_\symup{weiss}     &= \,(9.95\pm0.06)*10^{-11} \si{\frac{\volt}{\kelvin^4}} \\
  b_\symup{weiss}     &= (-0.794\pm0.008) \si{\volt} \\
  a_\symup{matt}      &= \,(1.67\pm0.07)*10^{-11} \si{\frac{\volt}{\kelvin^4}} \\
...
\end{align*}
Der Fehler berechnet sich dabei nach der Gaußschen Fehlerfortpflanzung (x).
