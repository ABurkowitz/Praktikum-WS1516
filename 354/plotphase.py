...
def g(ome,a_1,a_0,a_2,a_3):
    ...
    return (a_2*np.arctan(a_0*(ome/1000-a_1))+a_3)
params, covar = curve_fit(g,w,ph,p0=[40.000,0.00001,1,0])
x_plot1 = np.linspace(1000, 3000000, 100000)
plt.plot(x_plot1/1000, g(x_plot1, *params), 'b-', label="Fit")
plt.errorbar(w/1000, phi(a,b) + (a / 10), xerr=None, yerr=(a / 10), fmt='rx', label="Phasenverschiebung")
plt.legend(loc='best')
#plt.tight_layout(pad=0, h_pad=1.1, w_pad=1.08)
plt.xlim(1.6e2, 2.5e2)
